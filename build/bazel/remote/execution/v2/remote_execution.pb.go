...
type BatchUpdateBlobsRequest_Request struct {
	...
	// The compressor being used for this request.
...
func (m *BatchUpdateBlobsRequest_Request) GetCompressor() Compressor_Value {
	if m != nil {
		return m.Compressor
	}
...
type BatchReadBlobsRequest struct {
	...
	// Individual blobs to request in a compressed format.
	// Blobs requested in this field MAY request the identity compressor.
	// Servers SHOULD respond with blobs using the requested compressor.
	Requests             []*BatchReadBlobsRequest_Request `protobuf:"bytes,3,rep,name=requests,proto3" json:"requests,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}
...
func (m *BatchReadBlobsRequest) GetRequests() []*BatchReadBlobsRequest_Request {
	if m != nil {
		return m.Requests
	}
	return nil
...
// A request corresponding to a single blob that the client wants to download.
type BatchReadBlobsRequest_Request struct {
	// The digest to which this request corresponds.
	Digest *Digest `protobuf:"bytes,1,opt,name=digest,proto3" json:"digest,omitempty"`
	// The compression method to use for this request.
	Compressor           Compressor_Value `protobuf:"varint,2,opt,name=compressor,proto3,enum=build.bazel.remote.execution.v2.Compressor_Value" json:"compressor,omitempty"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}

func (m *BatchReadBlobsRequest_Request) Reset()         { *m = BatchReadBlobsRequest_Request{} }
func (m *BatchReadBlobsRequest_Request) String() string { return proto.CompactTextString(m) }
func (*BatchReadBlobsRequest_Request) ProtoMessage()    {}
func (*BatchReadBlobsRequest_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_c43847ba40caac95, []int{30, 0}
}

func (m *BatchReadBlobsRequest_Request) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_BatchReadBlobsRequest_Request.Unmarshal(m, b)
}
func (m *BatchReadBlobsRequest_Request) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_BatchReadBlobsRequest_Request.Marshal(b, m, deterministic)
}
func (m *BatchReadBlobsRequest_Request) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BatchReadBlobsRequest_Request.Merge(m, src)
}
func (m *BatchReadBlobsRequest_Request) XXX_Size() int {
	return xxx_messageInfo_BatchReadBlobsRequest_Request.Size(m)
}
func (m *BatchReadBlobsRequest_Request) XXX_DiscardUnknown() {
	xxx_messageInfo_BatchReadBlobsRequest_Request.DiscardUnknown(m)
}

var xxx_messageInfo_BatchReadBlobsRequest_Request proto.InternalMessageInfo

func (m *BatchReadBlobsRequest_Request) GetDigest() *Digest {
	if m != nil {
		return m.Digest
	}
	return nil
...
func (m *BatchReadBlobsRequest_Request) GetCompressor() Compressor_Value {
	if m != nil {
		return m.Compressor
	}
	return Compressor_IDENTITY
...
type BatchReadBlobsResponse_Response struct {
	...
	Status *status.Status `protobuf:"bytes,3,opt,name=status,proto3" json:"status,omitempty"`
	// The compression method being used for this response.
...
func (m *BatchReadBlobsResponse_Response) GetCompressor() Compressor_Value {
	if m != nil {
		return m.Compressor
	}
	return Compressor_IDENTITY
...
type CacheCapabilities struct {
	...
	// Whether the server supports compressing blobs for batch requests
	// (BatchUpdateBlobs / BatchReadBlobs).
	// Clients MUST NOT make such requests with any compressor other than identity
	// if this field is not true.
	BatchCompression     bool     `protobuf:"varint,7,opt,name=batch_compression,json=batchCompression,proto3" json:"batch_compression,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *CacheCapabilities) GetBatchCompression() bool {
	if m != nil {
		return m.BatchCompression
	}
	return false
}
...
func init() {
	...
	proto.RegisterType((*BatchReadBlobsRequest_Request)(nil), "build.bazel.remote.execution.v2.BatchReadBlobsRequest.Request")
...
var fileDescriptor_c43847ba40caac95 = []byte{
	...
	,
}
